...
<template>
  ...
  >
    ...
    <button type="button" class="btn btn-ghost btn-sm relative">
    ...
    <button type="button" class="btn btn-ghost btn-sm">
      <CircleHelp :size="16" :stroke-width="2" />
    </button>
    ...
    >
      <Avatar name="Anne Rochat" :size="28" />
      <div class="text-left leading-tight">
        <div class="text-[12px] font-medium">Anne Rochat</div>
        <div class="text-[10px] text-surface-500">Admin · BC Lausanne-Sud</div>
      </div>

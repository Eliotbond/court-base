...
// ---------------------------------------------------------------------------
// Lazy-load /categories — uniquement quand la section devient visible.
// Évite un fetch inutile au mount initial pour les utilisateurs qui ne vont
// jamais sur l'onglet Catégories.
// ---------------------------------------------------------------------------

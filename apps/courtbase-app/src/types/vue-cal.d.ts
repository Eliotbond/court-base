 ...
 * bundlé). On déclare uniquement ce que `TeamPlanning.vue` consomme (props +
 * structures d'events / splits).
 *
 * Aligné sur le shim équivalent dans `apps/web/src/types/vue-cal.d.ts`. Si on
 * étend l'usage (drag-and-drop, formats supplémentaires…), enrichir ici plutôt
 * que de répandre des `// any:` à travers le code.
 */
